...
## SW
##============================================================
#set_location_assignment PIN_AB30 -to in1
...
## LED
##============================================================
set_location_assignment PIN_AA24 -to thh
set_location_assignment PIN_AB23 -to make2
set_location_assignment PIN_AC23 -to break
set_location_assignment PIN_AD24 -to make1
set_location_assignment PIN_AG25 -to RANDOM[4]
set_location_assignment PIN_AF25 -to RANDOM[5]
set_location_assignment PIN_AE24 -to RANDOM[6]
set_location_assignment PIN_AF24 -to RANDOM[7]
set_location_assignment PIN_AB22 -to rise
set_location_assignment PIN_AC22 -to pulse
#
##============================================================
## Seg7
##============================================================
set_location_assignment PIN_W17 -to  dout_down[0]
set_location_assignment PIN_V18 -to  dout_down[1]
set_location_assignment PIN_AG17 -to dout_down[2]
set_location_assignment PIN_AG16 -to dout_down[3]
set_location_assignment PIN_AH17 -to dout_down[4]
set_location_assignment PIN_AG18 -to dout_down[5]
set_location_assignment PIN_AH18 -to dout_down[6]
set_location_assignment PIN_AF16 -to dout_up[0]
set_location_assignment PIN_V16 -to  dout_up[1]
set_location_assignment PIN_AE16 -to dout_up[2]
set_location_assignment PIN_AD17 -to dout_up[3]
set_location_assignment PIN_AE18 -to dout_up[4]
set_location_assignment PIN_AE17 -to dout_up[5]
set_location_assignment PIN_V17 -to  dout_up[6]
set_location_assignment PIN_AA21 -to d_bitrec_down[0]
set_location_assignment PIN_AB17 -to d_bitrec_down[1]
set_location_assignment PIN_AA18 -to d_bitrec_down[2]
set_location_assignment PIN_Y17 -to  d_bitrec_down[3]
set_location_assignment PIN_Y18 -to  d_bitrec_down[4]
set_location_assignment PIN_AF18 -to d_bitrec_down[5]
set_location_assignment PIN_W16 -to  d_bitrec_down[6]
set_location_assignment PIN_Y19 -to  d_bitrec_up[0]
set_location_assignment PIN_W19 -to  d_bitrec_up[1]
set_location_assignment PIN_AD19 -to d_bitrec_up[2]
set_location_assignment PIN_AA20 -to  d_bitrec_up[3]
set_location_assignment PIN_AC20 -to  d_bitrec_up[4]
set_location_assignment PIN_AA19 -to  d_bitrec_up[5]
set_location_assignment PIN_AD20 -to  d_bitrec_up[6]
